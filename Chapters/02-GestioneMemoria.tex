...
\begin{itemize}
    ...
    \item Anche se un metodo Java richiede un parametro di tipo \texttt{Optional<T>}, nulla vieta che venga passato esplicitamente \texttt{null} invece di un'istanza di \texttt{Optional}. Questo può portare comunque a \texttt{NullPointerException}, vanificando i benefici di sicurezza che \texttt{Optional} dovrebbe offrire.
\end{itemize}
