...
In questo capitolo verrà fornita una panoramica delle modalità con cui Java e Rust implementano e sfruttano il polimorfismo, mettendo a confronto le differenze concettuali e pratiche tra i due linguaggi. In particolare, verranno analizzati i meccanismi di polimorfismo dinamico e statico, evidenziando in che modo i due linguaggi implementano questi concetti.
...
\begin{minted} [fontsize=\small] {Java}
    ...
    class Child extends Parent {
        ...
        Object getValue() {
            return getValue(); // chiama String getValue()
        }
    }
\end{minted}
